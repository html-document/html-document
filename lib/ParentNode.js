...
var ParentNode = function($__super) {
  ...
  $__Object$defineProperty(ParentNode.prototype, "_childNodesRecursiveForEach", {
  ...
  $__Object$defineProperty(ParentNode.prototype, "_childNodesRecursiveFind", {
    value: function(callback) {
      var result;
  ...
  $__Object$defineProperty(ParentNode.prototype, "parentNode", {
    get: function() {
  ...
  $__Object$defineProperty(ParentNode.prototype, "previousSibling", {
    get: function() {
  ...
  $__Object$defineProperty(ParentNode.prototype, "nextSibling", {
    get: function() {
      var indexInParent = this.parentNode._childNodes.indexOf(this);
      if (indexInParent === -1) {
        throw new Error('Unexpected state: this node is not in the parent');
