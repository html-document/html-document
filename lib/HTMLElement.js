    ...
    _createClass(HTMLElement, [{
        ...
        * @param className */
        ...
        get: function get() {
            ...
            for (var _iterator = this._attributes, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _getIterator(_iterator);;) {
                var _ref;
                ...
                if (attr.value !== null && attr.value !== 'undefined') {
                    result += '="' + (0, _utilsEscapeAttribute2['default'])(attr.value) + '"';
                }
            }
