...
var _cssSelectorParser2 = _interopRequireDefault(_cssSelectorParser);
...
/** @class Element */
let Element = (function (_ParentNode) {
    ...
    _createClass(Element, [{
        ...
        * @param query */
        ...
        value: function querySelector(query) {
            let parser = new _cssSelectorParser2.default.CssSelectorParser();
             ...
             * @returns {boolean}
             */
            var processSelectors = function processSelectors(element, selectors) {
             ...
             * @returns {boolean}
             */
            var processRule = function processRule(element, rule) {
