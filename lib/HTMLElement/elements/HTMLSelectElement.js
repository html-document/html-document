 ...
 */
/** @class HTMLSelectElement */
let HTMLSelectElement = (function (_HTMLElement) {
    ...
    _createClass(HTMLSelectElement, [{
        ...
        * @member multiple */
        ...
        /** @memberof HTMLSelectElement 
        * @instance 
        * @param multiple */set: function set(multiple) {
            if (multiple) {
        ...
        * @member name */
        ...
        /** @memberof HTMLSelectElement 
        * @instance 
        * @param name */set: function set(name) {
        ...
        * @member selectedIndex */
        ...
        /** @memberof HTMLSelectElement 
        * @instance 
        * @param index */set: function set(index) {
        ...
        * @member size */
        ...
        /** @memberof HTMLSelectElement 
        * @instance 
        * @param size */set: function set(size) {
